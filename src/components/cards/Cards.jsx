...
const Cards = () => {
    return (
        <div className="cards-container">
            <div className="card">
                <div className="content">
                    ...
                    <p className="para">
                        ...
                        Soy Técnico Superior en Mecatrónica,
                        con experiencia en seguridad electrónica (alarmas, cámaras). 
                        Sin embargo mi pasión está en la programación.
            ...
            <div className="card">
            <div className="content">
                    <p className="heading">Cuales son mis metas</p>
                    <p className="para">
                       Aspiro a dominar las últimas tecnologías y marcos,
                       ...
                       de empleo que me permitan utilizar mis habilidades de programación y diseño de manera efectiva,
